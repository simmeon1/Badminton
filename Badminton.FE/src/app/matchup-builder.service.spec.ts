    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        },
        {
          ...
          pairing2: { player1: 'Bravo', player2: 'Charlie' },
        },
      ],
    });
  });
    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        },
        {
          ...
          pairing2: { player1: 'Alfa', player2: 'Charlie' },
        },
      ],
    });
  });
  ...
  it('MatchupsAsExpectedWith5Players3Games1Courts', () => {
    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        {
          pairing1: { player1: 'Delta', player2: 'Bravo' },
          pairing2: { player1: 'Echo', player2: 'Charlie' },
        },
      ],
    });
  });
    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        },
        {
          ...
          pairing2: { player1: 'Bravo', player2: 'Echo' },
        },
        {
          pairing1: { player1: 'Alfa', player2: 'Bravo' },
          pairing2: { player1: 'Charlie', player2: 'Echo' },
        },
        {
  ...
  it('MatchupsAsExpectedWith14Players4Games2Courts', () => {
    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        {
          pairing1: { player1: 'Echo', player2: 'Foxtrot' },
          pairing2: { player1: 'Golf', player2: 'Alfa' },
        },
        {
          pairing1: { player1: 'Bravo', player2: 'Charlie' },
          pairing2: { player1: 'Delta', player2: 'Echo' },
        },
        {
          pairing1: { player1: 'Foxtrot', player2: 'Golf' },
          pairing2: { player1: 'Alfa', player2: 'Charlie' },
        },
        {
          pairing1: { player1: 'Delta', player2: 'Foxtrot' },
          pairing2: { player1: 'Golf', player2: 'Bravo' },
        },
        {
          pairing1: { player1: 'Charlie', player2: 'Echo' },
          pairing2: { player1: 'Foxtrot', player2: 'Alfa' },
        },
        {
          pairing1: { player1: 'Bravo', player2: 'Delta' },
          pairing2: { player1: 'Echo', player2: 'Golf' },
        },
      ],
      2: [
        {
          pairing1: { player1: 'Hotel', player2: 'India' },
          pairing2: { player1: 'Juliett', player2: 'Kilo' },
        },
        {
          pairing1: { player1: 'Lima', player2: 'Mike' },
          pairing2: { player1: 'November', player2: 'Hotel' },
        },
        {
          pairing1: { player1: 'India', player2: 'Juliett' },
          pairing2: { player1: 'Kilo', player2: 'Lima' },
        },
        {
        ...
        {
          pairing1: { player1: 'Kilo', player2: 'Mike' },
          pairing2: { player1: 'November', player2: 'India' },
        },
        {
          pairing1: { player1: 'Juliett', player2: 'Lima' },
          pairing2: { player1: 'Mike', player2: 'Hotel' },
        },
        {
          pairing1: { player1: 'India', player2: 'Kilo' },
          pairing2: { player1: 'Lima', player2: 'November' },
        },
      ],
    });
  });
    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        },
        {
          ...
          pairing2: { player1: 'Echo', player2: 'Bravo' },
        },
        {
          pairing1: { player1: 'Charlie', player2: 'Echo' },
    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        },
        {
          ...
          pairing2: { player1: 'Delta', player2: 'Bravo' },
        },
      ],
    });
  });
  ...
  it('MatchupsAsExpectedWith4Players3Games1Courts', () => {
    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        {
          pairing1: { player1: 'Charlie', player2: 'Bravo' },
          pairing2: { player1: 'Delta', player2: 'Alfa' },
        },
      ],
    });
  });
    ...
    expect(extractMatchups(matchups)).toEqual({
      1: [
        ...
        },
        {
          ...
          pairing2: { player1: 'Alfa', player2: 'Bravo' },
        },
      ],
    });
  });
