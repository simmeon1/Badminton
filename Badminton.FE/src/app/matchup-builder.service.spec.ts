...
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Echo"},"pairing2":{"player1":"Bravo","player2":"Charlie"}}]}        )
    })

    it('MatchupsAsExpectedWith5Players2Games1Courts', () => {
        const matchups = service.getMatchups(names.slice(0, 5), 2, 1);
        expect(extractMatchups(matchups)).toEqual(
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Echo"},"pairing2":{"player1":"Bravo","player2":"Charlie"}},{"pairing1":{"player1":"Delta","player2":"Echo"},"pairing2":{"player1":"Alfa","player2":"Charlie"}}]}        )
    })

    it('MatchupsAsExpectedWith5Players3Games1Courts', () => {
        const matchups = service.getMatchups(names.slice(0, 5), 3, 1);
        expect(extractMatchups(matchups)).toEqual(
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Echo"},"pairing2":{"player1":"Bravo","player2":"Charlie"}},{"pairing1":{"player1":"Delta","player2":"Echo"},"pairing2":{"player1":"Alfa","player2":"Charlie"}},{"pairing1":{"player1":"Bravo","player2":"Delta"},"pairing2":{"player1":"Charlie","player2":"Echo"}}]}        )
    })

    it('MatchupsAsExpectedWith5Players5Games1Courts', () => {
        const matchups = service.getMatchups(names.slice(0, 5), 5, 1);
        expect(extractMatchups(matchups)).toEqual(
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Echo"},"pairing2":{"player1":"Bravo","player2":"Charlie"}},{"pairing1":{"player1":"Delta","player2":"Echo"},"pairing2":{"player1":"Alfa","player2":"Charlie"}},{"pairing1":{"player1":"Alfa","player2":"Delta"},"pairing2":{"player1":"Bravo","player2":"Echo"}},{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Echo"}},{"pairing1":{"player1":"Bravo","player2":"Delta"},"pairing2":{"player1":"Charlie","player2":"Echo"}},{"pairing1":{"player1":"Delta","player2":"Echo"},"pairing2":{"player1":"Alfa","player2":"Charlie"}}]}        )
    })

    it('MatchupsAsExpectedWith14Players4Games2Courts', () => {
        const matchups = service.getMatchups(names.slice(0, 14), 4, 2);
        expect(extractMatchups(matchups)).toEqual(
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Echo","player2":"Foxtrot"},"pairing2":{"player1":"Alfa","player2":"Golf"}},{"pairing1":{"player1":"Bravo","player2":"Charlie"},"pairing2":{"player1":"Delta","player2":"Echo"}},{"pairing1":{"player1":"Foxtrot","player2":"Golf"},"pairing2":{"player1":"Alfa","player2":"Charlie"}},{"pairing1":{"player1":"Delta","player2":"Foxtrot"},"pairing2":{"player1":"Bravo","player2":"Golf"}},{"pairing1":{"player1":"Charlie","player2":"Echo"},"pairing2":{"player1":"Alfa","player2":"Foxtrot"}},{"pairing1":{"player1":"Bravo","player2":"Delta"},"pairing2":{"player1":"Echo","player2":"Golf"}}],"2":[{"pairing1":{"player1":"Hotel","player2":"India"},"pairing2":{"player1":"Juliett","player2":"Kilo"}},{"pairing1":{"player1":"Lima","player2":"Mike"},"pairing2":{"player1":"Hotel","player2":"November"}},{"pairing1":{"player1":"India","player2":"Juliett"},"pairing2":{"player1":"Kilo","player2":"Lima"}},{"pairing1":{"player1":"Mike","player2":"November"},"pairing2":{"player1":"Hotel","player2":"Juliett"}},{"pairing1":{"player1":"Kilo","player2":"Mike"},"pairing2":{"player1":"India","player2":"November"}},{"pairing1":{"player1":"Juliett","player2":"Lima"},"pairing2":{"player1":"Hotel","player2":"Mike"}},{"pairing1":{"player1":"India","player2":"Kilo"},"pairing2":{"player1":"Lima","player2":"November"}}]},
        )
    })
...
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Echo"},"pairing2":{"player1":"Bravo","player2":"Charlie"}},{"pairing1":{"player1":"Delta","player2":"Echo"},"pairing2":{"player1":"Alfa","player2":"Charlie"}},{"pairing1":{"player1":"Alfa","player2":"Delta"},"pairing2":{"player1":"Bravo","player2":"Echo"}},{"pairing1":{"player1":"Bravo","player2":"Delta"},"pairing2":{"player1":"Charlie","player2":"Echo"}}]}        )
    ...
    it('MatchupsAsExpectedWith6Players4Games1Courts', () => {
        ...
        expect(extractMatchups(matchups)).toEqual(
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Echo","player2":"Foxtrot"},"pairing2":{"player1":"Alfa","player2":"Charlie"}},{"pairing1":{"player1":"Delta","player2":"Echo"},"pairing2":{"player1":"Alfa","player2":"Foxtrot"}},{"pairing1":{"player1":"Bravo","player2":"Charlie"},"pairing2":{"player1":"Delta","player2":"Foxtrot"}},{"pairing1":{"player1":"Alfa","player2":"Delta"},"pairing2":{"player1":"Bravo","player2":"Echo"}},{"pairing1":{"player1":"Charlie","player2":"Echo"},"pairing2":{"player1":"Bravo","player2":"Foxtrot"}}]}        )
    })
...
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}}]}        )
    ...
    it('MatchupsAsExpectedWith4Players2Games1Courts', () => {
        ...
        expect(extractMatchups(matchups)).toEqual(
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Charlie"},"pairing2":{"player1":"Bravo","player2":"Delta"}}]}        )
    })

    it('MatchupsAsExpectedWith4Players3Games1Courts', () => {
        const matchups = service.getMatchups(names.slice(0, 4), 3, 1);
        expect(extractMatchups(matchups)).toEqual(
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Charlie"},"pairing2":{"player1":"Bravo","player2":"Delta"}},{"pairing1":{"player1":"Bravo","player2":"Charlie"},"pairing2":{"player1":"Alfa","player2":"Delta"}}]}        )
    })
...
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Charlie"},"pairing2":{"player1":"Bravo","player2":"Delta"}},{"pairing1":{"player1":"Bravo","player2":"Charlie"},"pairing2":{"player1":"Alfa","player2":"Delta"}},{"pairing1":{"player1":"Bravo","player2":"Charlie"},"pairing2":{"player1":"Alfa","player2":"Delta"}},{"pairing1":{"player1":"Bravo","player2":"Delta"},"pairing2":{"player1":"Alfa","player2":"Charlie"}}]}        )
    ...
    it('MatchupsAsExpectedWith4Players6Games1Courts', () => {
        ...
        expect(extractMatchups(matchups)).toEqual(
{"1":[{"pairing1":{"player1":"Alfa","player2":"Bravo"},"pairing2":{"player1":"Charlie","player2":"Delta"}},{"pairing1":{"player1":"Alfa","player2":"Charlie"},"pairing2":{"player1":"Bravo","player2":"Delta"}},{"pairing1":{"player1":"Bravo","player2":"Charlie"},"pairing2":{"player1":"Alfa","player2":"Delta"}},{"pairing1":{"player1":"Bravo","player2":"Charlie"},"pairing2":{"player1":"Alfa","player2":"Delta"}},{"pairing1":{"player1":"Bravo","player2":"Delta"},"pairing2":{"player1":"Alfa","player2":"Charlie"}},{"pairing1":{"player1":"Charlie","player2":"Delta"},"pairing2":{"player1":"Alfa","player2":"Bravo"}}]}        )
    })
})
;
